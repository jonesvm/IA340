...
('s4@jmu.edu','s4','ISAT') 
  ...
  select * from student 
--Q2.2
insert into professor(p_email,p_name,office_number)
...
--Q2.5
/*We should edit the professor table first because the course table references the professor table  */
...
--Q2.6
/*We should update the course table first because we cannot delete professor 1 if they are teaching a class  */	
